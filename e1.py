...
Matteo Vilchez
E1.Fer un programa de càlcul de temperatures del mar. Les tasques a fer són:
...
for i in datos[0]:
    if 2000<max<i:
        ...
        min=i
print("Año",datos[0][0],"La temperatura minima es: ",min,"la temperatura maxima es: ",max," Y la media es",datos[0][-1])
for i in datos:
    print("Año","La temperatura minima es: ",min,"la temperatura maxima es: ",max," Y la media es")
